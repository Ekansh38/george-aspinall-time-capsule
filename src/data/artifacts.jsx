...
export const artifacts = [
  ...
  },
  {
    ...
    scans: [
      { src: '/newspaper.jpg', label: 'Japan Times & Advertiser — "Singapore Surrenders", February 1942' },
    ],
    chapter: 'changi',
    pageChapter: 'changi',
    description: 'The Straits Times front page, February 16, 1942',
    body: `On 15 February 1942, British General Arthur Percival surrendered Singapore to Japanese General Tomoyuki Yamashita. It was one of the largest surrender of British forces in history. Around about 80,000 Allied troops in Singapore became POWS, including about 15,000 Australians.\n\nThe fall of Singapore was a massive shock and suprise to Australia. Austrilia relied on Britain for a long time to protect the region. Prime Minister John Curtin called it "Australia's darkest hour." For George and the other soldiers, this newspaper headline was the moment everything changed. The beginning of years of brutal captivity that none of them had been prepared for.`,
    position: { x: 76, y: 22 },
    rotation: -12,
    SVG: NewspaperSVG,
    size: { w: 100, h: 130 },
